//
//  UnifiedNonLinearHOPSState.swift
//  sebbu-hops
//
...
extension UnifiedHOPSHierarchy {
    @usableFromInline
    internal struct NonLinearNormalizedHOPSStateFunc<Noise: ComplexNoiseProcess>: ~Copyable, ~Escapable, ODERHSFunction {
        @usableFromInline
        ...
        @inlinable
        public mutating func evaluate(t: Double, y state: borrowing NonLinearNormalizedHOPSState, dy result: inout NonLinearNormalizedHOPSState) {
...
//                scalarFactor = Relaxed.multiplyAdd(-LDaggerExpectations[unchecked: i].conjugate, z_i_shifted, scalarFactor)
        ...
        @inlinable
        public func zero() -> NonLinearNormalizedHOPSState {
            return .init(dimension: totalDimension, shiftDimension: hierarchyPointer.pointee.G.count)
        }
    }
    
    @usableFromInline
    internal struct NonLinearNormalizedHOPSState: ~Copyable, AdaptiveStepODESolverState {
        @inlinable
        ...
        @inlinable
        public mutating func assign(_ a: borrowing UnifiedHOPSHierarchy.NonLinearNormalizedHOPSState) {
            totalStateVector.copyComponents(from: a.totalStateVector)
            shiftVector.copyComponents(from: a.shiftVector)
        }
        
        @inlinable
        public mutating func assign(_ a: borrowing UnifiedHOPSHierarchy.NonLinearNormalizedHOPSState, multiplied: Double) {
        ...
        @inlinable
        public func distance(to: borrowing UnifiedHOPSHierarchy.NonLinearNormalizedHOPSState) -> Double {
        ...
        @inlinable
        public mutating func add(_ a: borrowing UnifiedHOPSHierarchy.NonLinearNormalizedHOPSState, multiplied: Double) {
            totalStateVector.add(a.totalStateVector, multiplied: multiplied)
            shiftVector.add(a.shiftVector, multiplied: multiplied)
        }
        
        @inlinable
        public mutating func assign(_ base: borrowing UnifiedHOPSHierarchy.NonLinearNormalizedHOPSState, adding direction: borrowing UnifiedHOPSHierarchy.NonLinearNormalizedHOPSState, multipliedBy c: Double) {
