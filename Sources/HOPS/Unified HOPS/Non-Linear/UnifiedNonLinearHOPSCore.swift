...
public extension UnifiedHOPSHierarchy {
    ...
    func solveNonLinear<Noise>(
        ...
        solve(start: start, end: end, initialTotalState: initialTotalState, H: H, noises: noises, noiseShifts: noiseShifts, equationType: .nonLinear, shiftType: shiftType, customOperators: customOperators, stepSize: stepSize, forEach: operation)
    }
    ...
    func solveNonLinear<Noise, WhiteNoise>(
        ...
        solve(start: start, end: end, initialTotalState: initialTotalState, H: H, noises: noises, noiseShifts: noiseShifts, equationType: .nonLinear, shiftType: shiftType, jumpOperators: jumpOperators, customOperators: customOperators, stepSize: stepSize, forEach: operation)
    }
}
