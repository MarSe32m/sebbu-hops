...
extension UnifiedHOPSHierarchy {
    @usableFromInline
    internal struct NonLinearHOPSQSDStateFunc<Noise: ComplexNoiseProcess, WhiteNoise: ComplexWhiteNoiseProcess>: ~Copyable, ~Escapable, SDERHSFunction {
    ...
    @usableFromInline
    internal struct NonLinearHOPSQSDState: ~Copyable, FixedStepSDESolverState {
